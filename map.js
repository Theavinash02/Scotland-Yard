...
function buildMap(){
  ...
  bigRect({fill:'url(#grain)',opacity:'0.12',style:'mix-blend-mode:multiply;pointer-events:none'});
  // districts & parks
  ...
  river.innerHTML=
    '<path d="'+rp+'" fill="none" stroke="#C6B78E" stroke-width="31" stroke-linecap="round" opacity="0.8"/>'+
    '<path d="'+rp+'" fill="none" stroke="#A6C6DB" stroke-width="26" stroke-linecap="round"/>'+
    '<path d="'+rp+'" fill="none" stroke="#BFD9E8" stroke-width="17" stroke-linecap="round" opacity="0.75"/>'+
    '<path d="'+rp+'" fill="none" stroke="#7FA9C4" stroke-width="1.4" stroke-dasharray="12 16" opacity="0.55"/>'+
  ...
  for(var i=1;i<=199;i++){
    ...
    var h='';
    if(hasU)h+='<circle r="'+r1(r+3.4)+'" fill="#FDF9EE" stroke="#C22B2B" stroke-width="2.4"/>';
    if(hasB)h+='<circle r="'+r1(r+1.6)+'" fill="'+(hasU?'none':'#FDF9EE')+'" stroke="#2F8A52" stroke-width="1.7"/>';
    h+='<circle r="'+r+'" fill="#FDFBF2" stroke="#4A4130" stroke-width="1.2"/>';
    ...
    if(modes.length>1){
      ...
      h+='<rect x="'+r1(-bw/2)+'" y="'+by+'" width="'+r1(bw)+'" height="5.6" rx="2.8" fill="#FDF9EE" stroke="#4A4130" stroke-width="0.7"/>';
...
function vehicleSvg(kind){
  if(kind==='t')return '<g>'+
    ...
    '<rect x="-3.6" y="-6.4" width="7.2" height="3" rx="1" fill="#BFE3F2"/>'+
    '<rect x="-2.2" y="-9.3" width="4.4" height="2.2" rx="0.9" fill="#20242B"/>'+
  ...
  if(kind==='b')return '<g>'+
    ...
    '<rect x="-11" y="-7.4" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/><rect x="-5" y="-7.4" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/><rect x="1" y="-7.4" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/><rect x="7" y="-7.4" width="4" height="3" rx="0.8" fill="#D7F0E2"/>'+
    '<rect x="-11" y="-2.6" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/><rect x="-5" y="-2.6" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/><rect x="1" y="-2.6" width="4.6" height="3" rx="0.8" fill="#D7F0E2"/>'+
  ...
  if(kind==='u')return '<g>'+
    ...
    '<circle cx="12.4" cy="0" r="1.5" fill="#FFE9A8"/></g>';
  if(kind==='boat')return '<g>'+
    ...
    '<rect x="1.6" y="-7.6" width="3" height="4.4" rx="0.8" fill="#E24A4A"/></g>';
  // black mystery sedan
  return '<g>'+
    '<rect x="-9.5" y="-4" width="19" height="7.2" rx="2.6" fill="#14181D" stroke="#F2C230" stroke-width="0.9"/>'+
    '<rect x="-5" y="-7.2" width="10" height="4.4" rx="1.7" fill="#14181D" stroke="#F2C230" stroke-width="0.9"/>'+
    '<rect x="-4" y="-6.4" width="8" height="3" rx="1" fill="#3A4656"/>'+
    '<circle cx="-5.4" cy="3.6" r="2.3" fill="#000"/><circle cx="5.4" cy="3.6" r="2.3" fill="#000"/>'+
    '<circle cx="-5.4" cy="3.6" r="0.9" fill="#F2C230"/><circle cx="5.4" cy="3.6" r="0.9" fill="#F2C230"/></g>';
}
